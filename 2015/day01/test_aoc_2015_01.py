from aoc_2015_01 import get_number_part1, get_number_part2
import unittest
...
class TestAOC(unittest.TestCase):
    ...
    def test_aoc_part1(self):        
        ...
        self.assertEqual(-1, solution_1)
        self.assertEqual(280, solution_2)
    ...
    def test_aoc_part2(self):        
        ...
        self.assertEqual(5, solution_1)
        self.assertEqual(1797, solution_2)
